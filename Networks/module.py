...
class GCM_interFA_ODE_slot_channel4_scribble_thin(nn.Module):
    def __init__(self, in_channels, out_channels, params):
        ...
        self.ft_chns = params['feature_chns']
        # self.T0 = ETM(int(in_channels/2), int(in_channels/4))
        # self.T1 = ETM(in_channels, int(in_channels/2))
        # self.T2 = ETM(in_channels * 2, in_channels)
        # self.T3 = ETM(in_channels * 4, in_channels * 2)
        # self.T4 = ETM(in_channels * 8, in_channels * 4)
    ...
    def forward(self, f0, f1, f2, f3, f4):
        ...
        # f4_2 = self.conv1X1_2(f4_2)
        
        return [f0_1, f1_1, f2_1, f3_1, f4_1], [f0_2, f1_2, f2_2, f3_2, f4_2]


class GCM_interFA_ODE_slot_channel4_scribble_thin_aux(nn.Module):
    def __init__(self, in_channels, out_channels, params):
        super(GCM_interFA_ODE_slot_channel4_scribble_thin_aux, self).__init__()
        self.ft_chns = params['feature_chns']
        # self.T1 = ETM(in_channels, out_channels)
        # self.T2 = ETM(in_channels * 2, out_channels)
        # self.T3 = ETM(in_channels * 4, out_channels )
