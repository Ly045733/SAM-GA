...
parser.add_argument('--exp', type=str,
                    default='ACDC/InterFA_SA_Two_big_xiu', help='experiment_name')
parser.add_argument('--fold', type=str,
                    default='fold1', help='cross validation')
parser.add_argument('--sup_type', type=str,
                    default='scribble', help='supervision type')
parser.add_argument('--model', type=str,
                    default='unet_cct_SA_thin', help='model_name')
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            loss_pse_sup = 0.5 * (dice_loss(outputs_soft1, pesudo_label_batch.unsqueeze(
                1)) + dice_loss(outputs_soft2, pesudo_label_batch.unsqueeze(1)))
